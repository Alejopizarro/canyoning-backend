...
export interface ApiCategoryCategory extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    categorySlug: Schema.Attribute.UID;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ...
    excursions: Schema.Attribute.Relation<
      'oneToMany',
      'api::excursion.excursion'
    >;
...
export interface ApiExcursionExcursion extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    quantityPeople: Schema.Attribute.Integer &
      Schema.Attribute.Required &
      Schema.Attribute.SetMinMax<
        {
          max: 10;
        ...
        number
      >;
    reserve: Schema.Attribute.Relation<'oneToMany', 'api::reserve.reserve'>;
    reserves: Schema.Attribute.Relation<'oneToMany', 'api::reserve.reserve'>;
...
export interface ApiReserveReserve extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    quantityPeople: Schema.Attribute.Integer;
    reserveSlug: Schema.Attribute.UID<'clientName'>;
    statusReserve: Schema.Attribute.Enumeration<
